...
const TableNameCalorieRecord = "calorie_record"

// CalorieRecord mapped from table <calorie_record>
...
// TableName CalorieRecord's table name
func (*CalorieRecord) TableName() string {
	return TableNameCalorieRecord
}
