...
const TableNameSpo2Record = "spo2_record"

// Spo2Record mapped from table <spo2_record>
...
// TableName Spo2Record's table name
func (*Spo2Record) TableName() string {
	return TableNameSpo2Record
}
