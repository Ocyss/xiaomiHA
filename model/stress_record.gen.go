...
const TableNameStressRecord = "stress_record"

// StressRecord mapped from table <stress_record>
...
// TableName StressRecord's table name
func (*StressRecord) TableName() string {
	return TableNameStressRecord
}
