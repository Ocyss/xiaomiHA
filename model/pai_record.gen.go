...
const TableNamePaiRecord = "pai_record"

// PaiRecord mapped from table <pai_record>
...
// TableName PaiRecord's table name
func (*PaiRecord) TableName() string {
	return TableNamePaiRecord
}
