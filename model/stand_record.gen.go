...
const TableNameStandRecord = "stand_record"

// StandRecord mapped from table <stand_record>
...
// TableName StandRecord's table name
func (*StandRecord) TableName() string {
	return TableNameStandRecord
}
