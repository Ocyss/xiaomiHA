...
const TableNameHearingHealthRecord = "hearing_health_record"

// HearingHealthRecord mapped from table <hearing_health_record>
...
// TableName HearingHealthRecord's table name
func (*HearingHealthRecord) TableName() string {
	return TableNameHearingHealthRecord
}
