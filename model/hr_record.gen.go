...
const TableNameHrRecord = "hr_record"

// HrRecord mapped from table <hr_record>
...
// TableName HrRecord's table name
func (*HrRecord) TableName() string {
	return TableNameHrRecord
}
