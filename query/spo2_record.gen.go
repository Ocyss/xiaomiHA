...
func newSpo2Record(db *gorm.DB, opts ...gen.DOOption) spo2Record {
	...
	_spo2Record.Time = field.NewInt32(tableName, "time")
	_spo2Record.Value = field.NewString(tableName, "value")
	_spo2Record.ZoneOffsetInSec = field.NewInt32(tableName, "zoneOffsetInSec")
	_spo2Record.ZoneName = field.NewString(tableName, "zoneName")
	_spo2Record.TimeIn0Tz = field.NewInt32(tableName, "timeIn0Tz")
	_spo2Record.IsUpload = field.NewInt32(tableName, "isUpload")
	_spo2Record.IsDeleted = field.NewInt32(tableName, "isDeleted")
